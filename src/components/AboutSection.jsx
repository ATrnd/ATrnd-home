  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundImage: 'url(/images/atrnd-about-mobile-v1.png)' }}
      ></div>

      {/* Desktop Image - 768px and up */}
      <div
        className="absolute inset-0 bg-contain bg-center bg-no-repeat hidden md:block"
        style={{ backgroundImage: 'url(/images/atrnd-about-v1.png)' }}
      ></div>

      {/* Glitch Effect Overlay */}
      <GlitchCanvas
        imageSrc="/images/atrnd-about-v1.png"
        mobileImageSrc="/images/atrnd-about-mobile-v1.png"
        intensity="low"
